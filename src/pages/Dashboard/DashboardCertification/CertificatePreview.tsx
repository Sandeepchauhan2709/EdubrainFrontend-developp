  ...
  if (!isCompleted) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-neutral-600 dark:text-neutral-300">
        ...
        <p className="text-sm">Complete the course to unlock your certificate</p>
      </div>
    );
  }
    ...
    <div className="relative w-full h-full bg-white dark:bg-neutral-900 p-8 rounded-lg border-8 border-double border-primary/20">
      ...
      <div className="flex flex-col items-center justify-center h-full space-y-6 text-center">
        <div className="space-y-2">
          <h2 className="text-2xl font-serif text-primary">Certificate of Completion</h2>
          <div className="w-32 h-1 mx-auto bg-primary/30 rounded" />
        </div>
        
        <p className="text-sm text-neutral-600 dark:text-neutral-400">This certifies that</p>
        
        <p className="text-xl font-semibold text-neutral-800 dark:text-neutral-200">{userName}</p>
