...
const CertificateModal: React.FC<CertificateModalProps> = ({ onClose, userName, courseName, completionDate,logoUrl }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center overflow-auto">
      <div className="bg-white p-8 rounded-xl max-w-4xl w-full">
        <h2 className="text-2xl font-bold mb-4">Course Completion Certificate</h2>
        <div id="certificate">
          <Certificate userName={userName} courseName={courseName} completionDate={completionDate} logoUrl={"http://localhost:3000/static/media/logo.bc4f089b129b04580c65.png"}/>
        </div>
